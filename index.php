...
<html lang="en">
    ...
    <body id="page-top">
            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li><a class="nav-link" href="panel/admin/login.php">login</a></li>
                    </ul>
                </div>
            </div>
        </nav>
        ...
        <!-- Footer-->
        <footer class="footer bg-black small text-center text-white-50"><div class="container px-4 px-lg-5">Copyright &copy; Teratai Putih Global 2 Bekasi 2023</div></footer>
        <!-- Bootstrap core JS-->
